...
This data package contains the data that powers the chart ["Literacy rate"](https://ourworldindata.org/grapher/cross-country-literacy-rates?overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 08, 2025.
