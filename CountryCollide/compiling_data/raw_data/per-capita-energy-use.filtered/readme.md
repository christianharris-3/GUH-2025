...
This data package contains the data that powers the chart ["Energy use per person"](https://ourworldindata.org/grapher/per-capita-energy-use?overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 08, 2025.
