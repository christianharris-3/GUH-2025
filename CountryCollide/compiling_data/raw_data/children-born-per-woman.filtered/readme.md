...
This data package contains the data that powers the chart ["Total fertility rate: births per woman"](https://ourworldindata.org/grapher/children-born-per-woman?overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 08, 2025.
